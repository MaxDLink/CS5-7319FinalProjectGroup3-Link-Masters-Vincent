...
class App extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const distribution = new aws_cloudfront_1.Distribution(this, 'WebAppDistribution', {
            defaultBehavior: {
                origin: new aws_cloudfront_origins_1.S3BucketOrigin(bucket, {
        ...
        // Deploy the HTML file to the bucket
        ...
        const api = new aws_apigatewayv2_1.HttpApi(this, 'AppApi', {
            apiName: 'AppApi',
            corsPreflight: {
                allowOrigins: ['*'], // Specify your actual domain instead of '*' in production
                allowMethods: [
